    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('commenter') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $comment->has('food') ? $this->Html->link($comment->food->name, ['controller' => 'Foods', 'action' => 'view', $comment->food->id]) : '' ?></td>
                <td><?= h($comment->commenter) ?></td>
                <td><?= h($comment->title) ?></td>
                <td><?= $this->Number->format($comment->score) ?></td>
