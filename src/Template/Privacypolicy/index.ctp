...
<div class="policy">
  <p>北関東グルメ運営事務局（以下「当社」といいます。）は、当社の提供するサービス（以下「本サービス」といいます。）における、ユーザーについての個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。</p>
  
  <h2>1.　取集する利用者情報及び収集方法</h2>
  <p>本ポリシーにおいて、「利用者情報」とは、ユーザーの識別に係る情報、通信サービス上の光導履歴、その他ユーザーのスマートフォン、PC等の端末においてユーザーまたはユーザーの端末に関連して生成または蓄積された情報であって、本ポリシーに基づき当社が収集するものを意味するものとします。</p>
  ...
  <p>ユーザーが、本サービスを利用するにあたり、ソーシャルネットワークサービス等の外部サービスとの連携を許可した場合には、その許可の際にご提供いただきます。</p>
  ...
  <p>当社は本サービスへのアクセス状況やその後利用方法に関する情報を収集することがあります。これには以下の情報が含まれます。</p>
  ...
  <h2>2.　利用目的</h2>
  <p>2-1　利用者情報は、2-2に定めるとおり本サービスの提供のために利用されるほか、2-3にあるとおり、その他の目的にも利用される場合があります。</p>
  
  <p>2-2　本サービスのサービス提供にかかわる利用者情報の具体的な利用目的は以下のとおりです。</p>
  
  <p>(1)本サービスに関する登録の受付、本人確認、利用料金の計算等本サービスの提供、維持、保護及び改善のため</p>
  <p>(2)本サービスに関するご案内、お問い合わせ等への対応のため</p>
  <p>(3)本サービスに関する当社の規約、ポリシー等（以下「規約等」といいます。）に違反する行為に対応するため</p>
  <p>(4)本サービスに関する規約等の変更などを通知するため</p>
  <p>(5)上記の利用目的に付随する利用目的のため</p>
  ...
  <p>2-3　上記2-2以外の利用目的は以下のとおりです。</p>
      ...
      <p>・端末情報・ログ情報・Cookie及び匿名ID・位置情報</p>
      <p>(2)当社または第三者の広告の配信または表示のため</p>
      <p>・端末情報・ログ情報・Cookie及び匿名ID・位置情報</p>
      <p>(3)その他マーケティングに利用するため</p>
      <p>・氏名・メールアドレス・その他当社が定める入力フォームにユーザーが入力する情報</p>
  <h2>3.　通知・公表または同意取得の方法、利用中止要請の方法</h2>
  <p>3-1　以下の利用者情報については、その収集が行われる前にユーザーの同意を得るものとします。</p>
  <p>(1)端末情報</p>
  <p>(2)位置情報</p>
  
  <p>3-2　ユーザーは、本サービスの所定の設定を行うことにより、利用者情報の全部または一部についてその利用の停止を求めることができ、この場合、当社は速やかに、当社の定めるところにした従い、その利用を停止します。なお利用者情報の項目によっては、その収集または利用が本サービスの前提となるため、当社所定の方法により本サービスを退会した場合に限り、当社はその収集を停止します。</p>
  
  <h2>4.　外部送信、第三者提供、情報収集モジュールの有無</h2>
  <p>利用者情報を利用したターゲティング広告の配信のため、本サービスには情報収集モジュールが組み込まれています。これに伴い、情報収集モジュール提供者への利用者情報の提供を行います。</p>
  <p>情報収集モジュール提供者に関しては「当サービス上における広告について(https://short-short.com/advertisement)」に記載しています。</p>
  ...
  <p>北関東グルメ運営事務局</p>
  <p>Email : kitakantouアットマークgmail.com（アットマークの部分には@が入ります。）</p>
  
  <h2>9.　プライバシーポリシーの変更手続</h2>
  <p>当社は、利用者情報の取扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、本ポリシーを変更することがあります。変更した場合にはWebサイト上でユーザーに通知いたします。但し、法令上ユーザーの同意が必要となるような内容の変更の場合は、当社所定の方法でユーザーの同意を得るものとします。</p>
</div>
    </div>
    <footer>  
