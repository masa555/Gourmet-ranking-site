...
class CommentFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comment_id' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-02-10 18:56:22',
            'modified' => '2018-02-10 18:56:22'
        ],
    ];
}
